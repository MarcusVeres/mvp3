            ...
            <div className="flex flex-col max-w-lg gap-12 mx-auto lg:w-full lg:max-w-none lg:flex-row rounded-3xl">
              <div className="flex-1 text-base lg:text-lg">
                ...
                <p className="pt-6">
                  ...
                  intensely and learn quickly to overcome obstacles and achieve
                  my objectives.
                </p>
                <p className="pt-6">
                  I believe that odds don't matter if you are tenacious, crazy,
                  or stupid enough to see your ideas through to the end. I love
                  what I do, and I am grateful I get to do it.
                </p>
              </div>
